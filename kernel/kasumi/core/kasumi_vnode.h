...
struct kasumi_vnode_info {
	...
	unsigned long v_ino;
	u8 flags;
	/* Visible path of a KASUMI_VNODE_F_VIRTUAL_DIR (source-less) node, used
	...
	/* For a char/blk/fifo source wrapper (KASUMI_VNODE_F_SPECIAL): the
